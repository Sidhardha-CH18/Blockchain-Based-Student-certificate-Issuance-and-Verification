...
import IssueCertificate from '../IssueCertificate'; // Import the IssueCertificate component
  ...
  return (
    <div className="relative min-h-screen w-full bg-black">
      ...
      <div className="relative z-10 min-h-screen">
        <header className="w-full px-6 py-4 backdrop-blur-md border-b border-pink-500/20">
          <div className="flex items-center justify-between">
            <div className="text-pink-500 font-mono text-xl tracking-wider">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="p-2 hover:bg-pink-500/10 rounded-full transition-colors">
                <SettingsIcon className="w-5 h-5 text-pink-300" />
              </button>
              <button className="p-2 hover:bg-pink-500/10 rounded-full transition-colors">
        ...
        <main className="p-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <button 
                onClick={() => handleNavClick('issueCertificate')}
